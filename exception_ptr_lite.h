...
current_exception()
{
    ...
    catch ( std::bad_exception     const & e ) { return make_exception_ptr( e ); }
    catch ( std::bad_alloc         const & e ) { return make_exception_ptr( e ); }
    catch ( std::bad_cast          const & e ) { return make_exception_ptr( e ); }
    catch ( std::bad_typeid        const & e ) { return make_exception_ptr( e ); }
    catch ( std::ios_base::failure const & e ) { return make_exception_ptr( e ); }
    catch ( std::underflow_error   const & e ) { return make_exception_ptr( e ); }
    catch ( std::overflow_error    const & e ) { return make_exception_ptr( e ); }
    catch ( std::range_error       const & e ) { return make_exception_ptr( e ); }
    catch ( std::runtime_error     const & e ) { return make_exception_ptr( e ); }

    catch ( std::out_of_range      const & e ) { return make_exception_ptr( e ); }
    catch ( std::length_error      const & e ) { return make_exception_ptr( e ); }
    catch ( std::domain_error      const & e ) { return make_exception_ptr( e ); }
    catch ( std::invalid_argument  const & e ) { return make_exception_ptr( e ); }
    catch ( std::logic_error       const & e ) { return make_exception_ptr( e ); }
    catch ( std::exception         const & e ) { return make_exception_ptr( e ); }
    catch (...)
    {
